...
// Tests for equality and inequality with strings
let firstName:string = "Mudasir";
let halfName:String = "Mudasir Sohail";
let fullNAme:string = "Mudasir Sohail Soomro";
...
// Test whether an item is in a array
let PAk_team:string[] = ["Babar Azam", "Shaheen", "Amir", "Rizwan"]
